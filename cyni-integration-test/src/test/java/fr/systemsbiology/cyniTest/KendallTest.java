...
public class KendallTest extends BasicIntegrationTest {
	...
	public void testLoadSession() throws Exception {
		...
		ListSingleSelection metrics = new ListSingleSelection<CyCyniMetric> (metricsManager.getCyniMetric("Kendall.cyni"));
		metrics.setSelectedValue (metricsManager.getCyniMetric("Kendall.cyni"));
